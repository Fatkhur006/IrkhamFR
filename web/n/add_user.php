...
if(isset($_POST["submit"])) {
  if (add_user($_POST) > 0 ) {
    echo "<script>alert('User berhasil ditambahkan !');document.location.href = 'users.php';</script>";
  } else {
    echo "<script>alert('User gagal ditambahkan !');document.location.href = 'add_user.php';</script>";
  }
}
        ...
        <div class="row4">
          ...
          <form class="" action="" method="post">
            <div class="col4-row4">
              ...
              <input class="c4-row4" type="text" name="name" required="required" value="" placeholder="...">
            </div>
            <div class="col2-row4">
                <label for>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input class="c4-row4" type="email" name="email" required="required" value="" placeholder="...">
            </div>
            <div class="col2-row4">
              <label for>Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input class="c4-row4" type="password" name="password" required="required" value="" placeholder="...">
            </div>
            <div class="col2-row4">
              <label for>Address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input class="c4-row4" type="text" name="address" required="required" value="" placeholder="...">
            </div>
            <div class="col2-row4">
              <label for>Phone Number</label>
              <input class="c4-row4" type="phone" name="phone" required="required" value="" placeholder="...">
            </div>
            <div class="col2-row4">
                <label for>Photo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <input class="c4-row4" type="text" name="photo" value="" placeholder="...">
            </div>
            <div class="">
              <ul>
                <li class="col6-row4" style="width:60px; margin-left:30px;"><a class="c3-row4" href="users.php">Cancel</a></li>
                <li class="float1"><button class="c3-row4 col6-row4" type="submit" name="submit">+ CREATE USER</button></li>
              </ul>
            </div>
          </form>
        </div>
